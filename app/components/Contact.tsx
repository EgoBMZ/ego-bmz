      ...
      <div className="section-container">
        <div className="relative rounded-3xl overflow-hidden p-10 md:p-16 reveal bg-[#161616] dark:bg-[#1A1A1A] border border-[var(--border)]">
          ...
          <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
            ...
            <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full blur-3xl opacity-10" style={{ background: 'var(--accent-soft)' }} />
          </div>
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <a href={`mailto:${EMAIL}`} id="email-link" className="btn-accent justify-center">
                {c.sendBtn[lang]}
            ...
            {/* Socials & Handle */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 mt-12 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              <div className="text-sm font-mono sm:ml-auto" style={{ color: 'rgba(245,243,238,0.45)' }}>
                {lang === 'es' ? 'Búscame en cualquier red como: ' : 'Find me anywhere as: '}
                <span style={{ color: 'var(--accent)' }}>@EgoBMZ</span>
              </div>
            </div>
          </div>
        </div>
